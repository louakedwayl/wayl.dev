...
const i18n = {
  en: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "HTML5 Interactive Ad Demos", description: "Lightweight HTML5/JS playable ad prototypes — tap-to-play mini-games designed for mobile user acquisition funnels." },
    ],
    seo: {
  ...
  fr: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "Démos publicitaires interactives HTML5", description: "Prototypes de publicités jouables HTML5/JS — mini-jeux tap-to-play conçus pour les tunnels d'acquisition mobile." },
    ],
    seo: {
  ...
  ru: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "Интерактивные HTML5-рекламные демо", description: "Прототипы играбельной рекламы на HTML5/JS — мини-игры tap-to-play для мобильных воронок привлечения." },
    ],
    seo: {
  ...
  ar: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "عروض إعلانية تفاعلية HTML5", description: "نماذج إعلانات قابلة للعب بتقنية HTML5/JS — ألعاب مصغرة بنقرة واحدة مصممة لقنوات اكتساب المستخدمين على الهاتف." },
    ],
    seo: {
  ...
  zh: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "HTML5互动广告演示", description: "轻量级HTML5/JS可玩广告原型——为移动端用户获取漏斗设计的点击即玩小游戏。" },
    ],
    seo: {
  ...
  ja: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "HTML5インタラクティブ広告デモ", description: "軽量なHTML5/JSプレイアブル広告プロトタイプ — モバイルUA向けタップ・トゥ・プレイのミニゲーム。" },
    ],
    seo: {
  ...
  es: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "Demos publicitarias interactivas HTML5", description: "Prototipos de anuncios jugables HTML5/JS — minijuegos tap-to-play diseñados para embudos de adquisición móvil." },
    ],
    seo: {
  ...
  it: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "Demo pubblicitarie interattive HTML5", description: "Prototipi di annunci giocabili HTML5/JS — mini-giochi tap-to-play progettati per funnel di acquisizione mobile." },
    ],
    seo: {
  ...
  nl: {
    ...
    projects: [
      ...
      { title: "PLAYABLE ADS", subtitle: "HTML5 interactieve advertentie-demo's", description: "Lichtgewicht HTML5/JS speelbare advertentieprototypes — tap-to-play minigames ontworpen voor mobiele acquisitie." },
    ],
    seo: {
...
const PROJECT_BASE = [
  ...
  { id: 2, tags: ["HTML5", "JAVASCRIPT", "CANVAS", "GAMEDEV"], image: "/Playable_layout.png", url: "https://playable.wayl.dev" },
];
