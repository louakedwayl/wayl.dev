export const i18n = {
  en: {
    ...
    seo: {
      home: { title: "Wayl Louaked — Full-Stack Developer & AI Engineer", description: "Wayl Louaked — Full-stack developer building performant web applications and AI-powered product experiences. Engineering student at École 42 Paris." },
      portfolio: { title: "Portfolio | Wayl Louaked", description: "Selected full-stack development and AI product projects by Wayl Louaked." },
      contact: { title: "Contact | Wayl Louaked", description: "Get in touch with Wayl Louaked for full-stack development and AI product inquiries." },
    },
  ...
  fr: {
    ...
    seo: {
      home: { title: "Wayl Louaked — Développeur Full-Stack & Ingénieur IA", description: "Wayl Louaked — Développeur full-stack concevant des applications web performantes et des expériences produit augmentées par l'IA. Étudiant ingénieur à l'École 42 Paris." },
      portfolio: { title: "Portfolio | Wayl Louaked", description: "Projets sélectionnés en développement full-stack et produits IA par Wayl Louaked." },
      contact: { title: "Contact | Wayl Louaked", description: "Contactez Wayl Louaked pour toute demande en développement full-stack et produit IA." },
    },
  ...
  ru: {
    ...
    seo: {
      home: { title: "Wayl Louaked — Фулстек-разработчик и AI-инженер", description: "Wayl Louaked — Фулстек-разработчик, создающий производительные веб-приложения и AI-продукты. Студент-инженер в École 42 Paris." },
      portfolio: { title: "Портфолио | Wayl Louaked", description: "Избранные проекты в области фулстек-разработки и AI-продуктов от Wayl Louaked." },
      contact: { title: "Контакт | Wayl Louaked", description: "Свяжитесь с Wayl Louaked по вопросам фулстек-разработки и AI-продуктов." },
    },
  ...
  ar: {
    ...
    seo: {
      home: { title: "Wayl Louaked — مطور متكامل ومهندس ذكاء اصطناعي", description: "Wayl Louaked — مطور متكامل يبني تطبيقات ويب عالية الأداء وتجارب منتجات مدعومة بالذكاء الاصطناعي. طالب هندسة في École 42 Paris." },
      portfolio: { title: "الأعمال | Wayl Louaked", description: "مشاريع مختارة في التطوير المتكامل ومنتجات الذكاء الاصطناعي من Wayl Louaked." },
      contact: { title: "اتصل | Wayl Louaked", description: "تواصل مع Wayl Louaked لاستفسارات التطوير المتكامل ومنتجات الذكاء الاصطناعي." },
    },
  ...
  zh: {
    ...
    seo: {
      home: { title: "Wayl Louaked — 全栈开发者 & AI工程师", description: "Wayl Louaked — 全栈开发者，构建高性能 Web 应用和 AI 驱动的产品体验。巴黎42学校工程学位在读。" },
      portfolio: { title: "作品集 | Wayl Louaked", description: "Wayl Louaked精选的全栈开发和 AI 产品项目。" },
      contact: { title: "联系 | Wayl Louaked", description: "联系Wayl Louaked，了解全栈开发和 AI 产品相关事宜。" },
    },
